        ...
        <div id="drag-region">
          ...
          <div id="window-controls">
            <div className="button" id="min-button" onClick={context.minimize}>
              <img className="icon" srcSet={`${minw10} 1x, ${minw12} 1.25x, ${minw15} 1.5x, ${minw15} 1.75x, ${minw20} 2x, ${minw20} 2.25x, ${minw24} 2.5x, ${minw30} 3x, ${minw30} 3.5x`} draggable="false" />
            </div>
            <div className="button" id="max-button" onClick={context.maximizeRestore}>
              <img className="icon" srcSet={`${maxw10} 1x, ${maxw12} 1.25x, ${maxw15} 1.5x, ${maxw15} 1.75x, ${maxw20} 2x, ${maxw20} 2.25x, ${maxw24} 2.5x, ${maxw30} 3x, ${maxw30} 3.5x`} draggable="false" />
            </div>
            <div className="button" id="restore-button" onClick={context.maximizeRestore}>
              <img className="icon" srcSet={`${restorew10} 1x, ${restorew12} 1.25x, ${restorew15} 1.5x, ${restorew15} 1.75x, ${restorew20} 2x, ${restorew20} 2.25x, ${restorew24} 2.5x, ${restorew30} 3x, ${restorew30} 3.5x`} draggable="false" />
            </div>
            <div className="button" id="close-button" onClick={context.close}>
              <img className="icon" srcSet={`${closew10} 1x, ${closew12} 1.25x, ${closew15} 1.5x, ${closew15} 1.75x, ${closew20} 2x, ${closew20} 2.25x, ${closew24} 2.5x, ${closew30} 3x, ${closew30} 3.5x`} draggable="false" />
            </div>
          </div>
        </div>
      </div>
